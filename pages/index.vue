        ...
        <v-row align="center" justify="center">
          <v-dialog v-model="dialog" width="500">
            ...
            <v-card
              ...
              "
            >
              <v-card-title class="headline"> ทำการจองสำเร็จ </v-card-title>
              <v-card-actions>
                <v-spacer />
...
.theme--dark.v-application {
  background-image: url('https://ak-d.tripcdn.com/images/200o1e000001eyjpgCF59_R_550_412_R5_Q70_D.jpg');
